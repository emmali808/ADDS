...
def test_query(ehr_file,processed_file,batch_size,dtype,add_admission):
    ...
    ## query_dataloader,aff_mat,cohorts = construct_query_dataloder(tokenizer,processed_file,ehr_file,batch_size,dtype='onto')
    ## query_dataloader,aff_mat,cohorts = construct_query_dataloder(tokenizer,processed_file,ehr_file,batch_size,dtype='undirect_onto')
    query_dataloader,aff_mat,cohorts = construct_query_dataloder(tokenizer,processed_file,ehr_file,batch_size,dtype='undirect_onto')
    ## print(query_dataloader)
    ## print(aff_mat)
    ## print(cohorts)

...
function GPSCoder()  {
    ...
    gcj_decrypt : function (gcjLat, gcjLon) {
        ...
        return {'lat': (gcjLat - d.lat).toFixed(6), 'lng': (gcjLon - d.lng).toFixed(6)};
    },
    //GCJ-02 to WGS-84 exactly   Marth to GPS
    ...
    bd_encrypt : function (gcjLat, gcjLon) {
        ...
        return {'lat' : bdLat.toFixed(6),'lng' : bdLon.toFixed(6)};
    },
    //BD-09 to GCJ-02

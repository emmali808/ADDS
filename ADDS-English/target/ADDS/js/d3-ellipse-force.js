(function (global, factory) {
    ...
    var ellipseForce = function (padding, innerRepulsion, outerRepulsion) {
        ...
        if (typeof padding !== "function") padding = constant(padding == null ? 10 : +padding);
        innerRepulsion = innerRepulsion == null ? 2.8 : +innerRepulsion;
        outerRepulsion = outerRepulsion == null ? 2.8 : +outerRepulsion;
        ...
        function force(alpha) {
            var i, j, n = nodes.length,
                ...
                // parameters
                myOuterRepulsion = outerRepulsion * 25;

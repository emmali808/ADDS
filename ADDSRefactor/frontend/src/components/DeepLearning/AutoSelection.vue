<template>
  <el-main>
    ...
    <el-dialog title="New Task" :visible.sync="addTaskFormVisible" width="640px"
      ...
      <el-form ref="addAutoSelectionTaskForm" :model="addAutoSelectionTaskForm" :rules="rules" label-position="left" label-width="140px">
        <el-form-item label="Name" prop="name">
          <el-input v-model="addAutoSelectionTaskForm.name" placeholder="Input task name"></el-input>
        </el-form-item>
        <el-form-item label="Dataset" prop="dataset">
          <el-select v-model="addAutoSelectionTaskForm.datasetId" placeholder="Choose a dataset">
        ...
        <el-form-item label="Metric" prop="metric">
          <el-select v-model="addAutoSelectionTaskForm.metricId" placeholder="Choose a metric">
        ...
        <el-form-item label="Query Length" prop="queryLength">
          <el-input v-model="addAutoSelectionTaskForm.queryLength" placeholder="Input query length"></el-input>
        </el-form-item>
        <el-form-item label="Document Length" prop="documentLength">
          <el-input v-model="addAutoSelectionTaskForm.documentLength" placeholder="Input document length"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="addAutoSelectionTask">Submit</el-button>
        <el-button @click="cancelAddAutoSelectionTask">Cancel</el-button>
      </div>
    </el-dialog>
          ...
          <div class="content">
            <div class="item-list">
              <el-table ref="autoSelectionTaskTable" :data="autoSelectionTaskTableData" :max-height="autoSelectionTaskTableHeight">
                <template slot="empty">
                  <span>{{autoSelectionTaskTableEmptyText}}</span>
                </template>
...
<!--        <a :href="'/task/autoSelection/downloadResult/' + this.currentResultTaskId">Download</a>-->
<!--        <el-link target="_blank" :href="'/task/autoSelection/downloadResult/' + this.currentResultTaskId">-->
    ...
    export default {
        ...
        methods: {
            ...
            closeAddAutoSelectionTaskForm() {
                ...
                this.addAutoSelectionTaskForm.metricId = '';
            ...
            beginTask(taskId) {
                this.$axios({
                    ...
                    this.$message({
                        type: 'error',
                        message: '[ERROR: AutoSelection.vue -> beginTask()] Check Console plz! ',
                        showClose: true
                    });
                    console.log(error);
                });
